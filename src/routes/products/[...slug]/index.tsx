	...
	return (
		<div>
			<div class="max-w-6xl mx-auto px-4 py-10">
				<div>
					<h2 class="text-3xl sm:text-5xl font-light tracking-tight text-gray-900 dark:text-gray-300 my-8">
						...
						<div class="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
							...
							{1 < productSignal.value.variants.length && (
								<div class="mt-4">
									...
									<select
										class="mt-1 bg-white dark:bg-neutral-800 dark:text-gray-300 dark:border-gray-800 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm rounded-md"
							...
							<div class="mt-10 flex flex-col sm:flex-row sm:items-center">
								<Price
									...
									forcedClass="text-3xl text-gray-900 dark:text-gray-300 mr-4"
								></Price>
